...
<div id="page-heading"><h1>Upload Event Pictures</h1></div>

<s:actionerror theme="jquery"/>  
     <s:form action="uploadshowimg"  enctype="multipart/form-data" theme="simple">
...
<tr>
	...
	<td>
        ...
        <s:hidden name="showId" value="%{showId}"/>   
				<tr>
	<th width="130">Select Event Logo*:</th>
	<td width="1"><s:file name="logo" cssClass="file_1"></s:file></td>
    <td>
    </td>
	<td width="431">
	...
	<tr>
	<th>Select Event Layout*:</th>
	<td>  <s:file name="layout" cssClass="file_1"></s:file></td>
    <td width="85">
    </td>
	...
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
			<s:submit label="Upload" cssClass="button"/>
