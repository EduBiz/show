...
<div id="page-heading"><h1>Select Images For Stall</h1></div>
<s:actionerror theme="jquery"/>  

            <s:form action="uploadstallimg"  enctype="multipart/form-data" theme="simple"><table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
<tr>
...
<tr>
	...
	<th>Select Stall Logo:</th>
	<td><s:file name="logo" cssClass="file_1"></s:file></td>
    <td width="83">
    </td>
	<td>
	<div class="bubble-left" cssClass="file_1"></div>
	<div class="bubble-inner">JPEG, GIF 5MB max per image</div>
	<div class="bubble-right"></div>
	</td>
	</tr>
	<tr>
	<th>Select Stall Banner Image:</th>
