...
public class useRegistration extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        try {
            ...
            if (user.getUserType().equals(type.Admin.getUserType())) {
                addActionMessage("Your Account Information Successfully Updated");
                return "admin";
            } else if (user.getUserType().equals(type.Show.getUserType())) {
                addActionMessage("Your Account Information Successfully Updated");
                return "show";
            } else if (user.getUserType().equals(type.Stall.getUserType())) {
                addActionMessage("Your Account Information Successfully Updated");
                return "stall";
            } else {
                return "error";
